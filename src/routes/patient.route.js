...
router.put("/profile/:Id", validate(patientValidator.userIdParamSchema, 'params'), validate(patientValidator.updatePatientProfileSchema), patientController.updatePatientProfile);
router.get("/profile/:Id", validate(patientValidator.userIdParamSchema, 'params'), patientController.getProfileByUserId);
